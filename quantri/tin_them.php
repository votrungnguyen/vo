                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="TieuDe_KhongDau" placeholder="Tiêu đề không dấu" required>
								...
								<div class="row cleafix">
								  ...
								  <div class="col-md-6">
									 <div class="form-group form-float">
									 <div class="form-line">
									 <input  type="text" class=" datepicker form-control" name="Ngay" placeholder="Ngày đăng">
									 </div>
									 </div>
								  </div>
								</div>
